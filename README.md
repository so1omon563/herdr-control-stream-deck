...
[Download Herdr Control v0.2.0](https://github.com/so1omon563/herdr-control-stream-deck/releases/download/v0.2.0/Herdr-Control-v0.2.0.streamDeckPlugin)
...
1. Download the current
   [Herdr Control installer](https://github.com/so1omon563/herdr-control-stream-deck/releases/download/v0.2.0/Herdr-Control-v0.2.0.streamDeckPlugin)
   and its
   [SHA-256 checksum](https://github.com/so1omon563/herdr-control-stream-deck/releases/download/v0.2.0/Herdr-Control-v0.2.0.streamDeckPlugin.sha256).
2. Optionally verify the download in Terminal:

   ```sh
   cd ~/Downloads
   shasum -a 256 -c Herdr-Control-v0.2.0.streamDeckPlugin.sha256
   ```

   A valid download reports `Herdr-Control-v0.2.0.streamDeckPlugin: OK`.
3. Double-click `Herdr-Control-v0.2.0.streamDeckPlugin` and approve the plugin
